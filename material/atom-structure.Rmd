...
### Gradient
If an atom is differentiable, we also define its gradient in an S4 class method. TODO: This is because... The gradient of the quadratic-over-linear function is
$$
