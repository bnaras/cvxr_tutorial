...
```{r}
alphas <- c(10, 8, 6, 4, 1)
S <- Variable(c(n, n), PSD = TRUE)    ## Variable constrained to positive semidefinite cone
...
In the code above, the `Variable` constructor restricts `S` to the
...
undefined for a positive semidefinite object in `CVXR`.
